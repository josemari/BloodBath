...
import org.jomaveger.math.MathHelper;
...
public class Frustum {
    ...
    public void normalizePlane(float[][] frustum, int side) {
        ...
        float magnitude = MathHelper.Sqrt(frustum[side][A] * frustum[side][A]
    ...
    public boolean cubeInFrustum(Vector center, float size) {
     ...
     */
    public Frustum() {
        modl_b = BufferUtil.INSTANCE.createFloatBuffer(16);
        proj_b = BufferUtil.INSTANCE.createFloatBuffer(16);
    }
}
